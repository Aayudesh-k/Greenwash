    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-4 gap-4">
        ...
        <Card className="p-6 bg-white dark:bg-slate-900 border border-slate-200/60 dark:border-slate-800 shadow-sm">
          ...
          <div className="text-slate-900 dark:text-slate-100 mb-1">
            {data.deforestationArea.toLocaleString()}
          </div>
        ...
        <Card className="p-6 bg-white dark:bg-slate-900 border border-slate-200/60 dark:border-slate-800 shadow-sm">
          ...
          <div className="text-slate-900 dark:text-slate-100 mb-1">
            {data.wasteGenerated.toLocaleString()}
          </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                <p className="text-red-900 dark:text-red-400">
                  <strong>Critical Finding:</strong> Deforestation has increased
                  65% above baseline targets, with acceleration in 2022-2023.
                  This directly contradicts the company's "zero deforestation"
